...
version = "EdgeAI-v0.2.0" // Version number, must match Git Tag
    ...
    publishing {
        publications {
            create<MavenPublication>("release") {
                ...
                artifactId = "EdgeAI"
                version = "EdgeAI-v0.2.0" // Must match the version above
            }
        }
    }
}
...
```kotlin
version = "EdgeAI-v0.2.0"  // Increment version number
```
...
git commit -m "Release EdgeAI EdgeAI-v0.2.0"
...
```
https://jitpack.io/#mtkresearch/BreezeApp-engine/EdgeAI-v0.2.0
```
...
# 2. Commit & Push
git commit -am "Release EdgeAI-v0.2.0"
git push origin main
